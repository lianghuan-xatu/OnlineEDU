...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
       ...
       // String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("D:\\IDEA WORKSPACE4\\OnlineEDU\\onlineedu-api\\src\\main\\java");
        ...
        strategy.setInclude("edu_chapter","edu_comment","edu_course","edu_course_collect","edu_course_description","edu_subject","edu_teacher","edu_video");  //设置要要映射的表名
